...
#Preselection = "(dphi_jet0_ptmiss > 0.4) && (dphi_jet1_ptmiss > 0.4) && (n_jet>=4) && (n_bjet>=1) && (jet_pt[0]>25e3) && (jet_pt[1]>25e3) && (jet_pt[2]>25e3) && (jet_pt[3]>25e3) && !((mT2tauLooseTau_GeV > -0.5) && (mT2tauLooseTau_GeV < 80)) && (mt>30e3) && (met>230e3)"
Preselection = "(n_jet>=4)&&(n_bjet>0) && (mt>90e3) && (met>230e3)"



_PREFIX = "/project/etp5/dhandl/samples/SUSY/Stop1L/AnalysisChallenge2018/skimmed"
#_PREFIX = "/project/etp5/dhandl/samples/ttbar_rew/TRUTH3/"

Signal = [
	#Sample("stop_tN_500_327", _load_chain([_PREFIX+"/stop_tN_500_327.root"], "bkgs_Nom"), ),
	Sample("stop_tN_800_500", _load_chain([_PREFIX+"/stop_tN_800_500/*.root"], "bkgs_Nom"), ),
...
Background = [
	Sample("bkgs", _load_chain([_PREFIX+"/bkgs/*.root"], "bkgs_Nom"), ),
