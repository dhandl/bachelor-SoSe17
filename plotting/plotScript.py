...
wwwDir = '/project/etp5/dhandl/MachineLearning/plots/evaluateRNNTruthReo/outputTransform/zoomInOutput/'
...
def main():
    ...
    output = {'name':'myRNN','fileName':fileName+'_RNN_output'+normString+logString, 'varStr':'outputScore', 'Xtitle':'RNN', 'Ytitle':'Events', 'binning':[0.70,0.72,0.74,0.76,0.78,0.80,0.82,0.84,0.86,0.88,0.90,1.0], 'binningIsExplicit':True}
    #output = {'name':'myRNN','fileName':fileName+'_RNN_output'+normString+logString, 'varStr':'outputScore', 'Xtitle':'RNN', 'Ytitle':'Events', 'binning':[20,0.,1.0], 'binningIsExplicit':False}
...
#--- Set cuts
    ...
    cut = '(n_jet>=4) && (n_lep==1) && (lep_pt[0]>25e3) && (n_bjet>=1) && (mt>=110e3) && (met>=230e3) && (jet_pt[0]>=25e3) && (jet_pt[1]>=25e3) && (jet_pt[2]>=25e3) && (jet_pt[3]>=25e3) && (dphi_jet0_ptmiss > 0.4) && (dphi_jet1_ptmiss > 0.4) && !((mT2tauLooseTau_GeV > -0.5) && (mT2tauLooseTau_GeV < 80.0))'
